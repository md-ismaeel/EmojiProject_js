const emojiList = [
  ...
  },
  {
    ...
    category: "Smileys & Emotion",
    aliases: ["smiling_face_with three hearts"],
    tags: ["love"],
  ...
  },
  {
    ...
    category: "Smileys & Emotion",
    aliases: ["stuck_out tonguewinking eye"],
    tags: ["prank", "silly"],
    unicode_version: "6.0",
    ios_version: "6.0",
  },
  ...
  },
  {
    ...
    category: "Smileys & Emotion",
    aliases: ["stuck_out_tongue closed eyes"],
    tags: ["prank"],
    unicode_version: "6.0",
    ios_version: "6.0",
  },
  ...
  },
  {
    ...
    category: "People & Body",
    aliases: ["tipping_hand_person", "information desk person"],
    tags: [],
    unicode_version: "6.0",
    ios_version: "6.0",
    skin_tones: true,
...
textType.addEventListener("keyup", () => {
  let inputVal = textType.value;

  let response = emojiList.filter((ele) => {
    return (
      ele.description.includes(inputVal) ||
      ele.aliases.includes(inputVal) ||
      ele.tags.includes(inputVal)
    );
  });
